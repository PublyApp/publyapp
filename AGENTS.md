...
For route-level TanStack Query cache warming conventions, see:
[`docs/guides/frontend-route-query-preloading.md`](docs/guides/frontend-route-query-preloading.md)
