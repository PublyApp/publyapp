...
// Lazy-loaded so the dialog's client-only `interZodClient` (`i18n.client.ts`)
// import stays OUT of this route module's static (server) import graph —
// TanStack Start's import-protection forbids a route module importing a
// `.client` module. The authed route is CSR (ssr:false) regardless.
const EmailDialog = lazy(() => import('~/components/email-dialog'));
