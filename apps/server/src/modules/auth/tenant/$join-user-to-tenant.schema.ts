...
import Parse_JoinUserToTenant from './$join-user-to-tenant.class';
import ParseTenant from './tenant.class';

// eslint-disable-next-line @typescript-eslint/naming-convention
const Parse_CustomJoinUserToTenantSchema = SchemaManager.defineSchema(Parse_JoinUserToTenant.className, {
	fields: {
