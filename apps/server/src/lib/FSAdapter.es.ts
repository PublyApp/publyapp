...
// 				.createHash('sha256')
// 				.update(String(options.encryptionKey))
// 				.digest('base64')
// 				.substr(0, 32);
// 		}
...
// 			const fileNamesNotRotated = fileNames;
...
// 								fileNamesNotRotated = fileNamesNotRotated.filter((value) => {
...
// 	getFileLocation(config: any, filename: string) {
...
// 	_getLocalFilePath(filename: string) {
// 		const applicationDir = this._getApplicationDir();
