...
// 			return file.name.toLowerCase().indexOf(name.toLowerCase()) !== -1;
// 		});
// 	}

// 	if (type.length) {
// 		inputData = inputData.filter((file) => {
// 			return type.includes(fileFormat(file.type));
// 		});
// 	}
...
// 			inputData = inputData.filter((file) => {
// 				return fTimestamp(file.createdAt) >= fTimestamp(startDate) && fTimestamp(file.createdAt) <= fTimestamp(endDate);
// 			});
// 		}
// 	}
