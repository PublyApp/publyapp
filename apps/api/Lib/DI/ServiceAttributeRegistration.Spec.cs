...
public sealed class ServiceAttributeRegistrationSpec
	...
	private static readonly (
		...
		(typeof(IDeadLetterQueryService), typeof(DeadLetterQueryService)),
		(typeof(IJobQueueQueryService), typeof(JobQueueQueryService)),
		(typeof(ISystemJobDefinitionQueryService), typeof(SystemJobDefinitionQueryService)),
		...
		(typeof(ITenantUsageService), typeof(TenantUsageService)),
