...
public class UserPermissionsForStaff : ISlicePermissions {
	...
	public UserPermissionsForStaff() {
		...
		UPDATE_EMAIL_FOR_STAFF = Permission
			.CreateStaffPermission(string.Join(Permission.KeySeparator, new[] { KeyPrefix, "update_email_for_staff" }))
		...
		SUSPEND_FOR_STAFF = Permission
			.CreateStaffPermission(string.Join(Permission.KeySeparator, new[] { KeyPrefix, "suspend_for_staff" }))
		...
		REACTIVATE_FOR_STAFF = Permission
			.CreateStaffPermission(string.Join(Permission.KeySeparator, new[] { KeyPrefix, "reactivate_for_staff" }))
		...
		GET_PROFILES_FOR_STAFF = Permission
			.CreateStaffPermission(string.Join(Permission.KeySeparator, new[] { KeyPrefix, "get_profiles_for_staff" }))
		...
		UPDATE_PROFILES_FOR_STAFF = Permission
			.CreateStaffPermission(string.Join(Permission.KeySeparator, new[] { KeyPrefix, "update_profiles_for_staff" }))
