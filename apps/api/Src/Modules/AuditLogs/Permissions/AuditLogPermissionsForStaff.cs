	...
	public AuditLogPermissionsForStaff() {
		LIST = Permission
			...
			.SetTranslation(
				...
				new PermissionTranslation {
					...
					Description = "View list of all audit logs"
				}
			)
			.SetTranslation(
				SupportedLanguage.French,
				new PermissionTranslation {
					Name = "Lister les journaux d'audit",
					Description = "Voir la liste de tous les journaux d'audit"
				}
			);
		...
		GET = Permission
			...
			.SetTranslation(
				...
				new PermissionTranslation {
					Name = "Get audit log",
					Description = "View details of an audit log entry"
				}
			)
			.SetTranslation(
				SupportedLanguage.French,
				new PermissionTranslation {
					Name = "Voir un journal d'audit",
					Description = "Voir les details d'une entree du journal d'audit"
				}
			);
		...
		EXPORT = Permission
			...
			.SetTranslation(
				SupportedLanguage.French,
				new PermissionTranslation {
					Name = "Exporter les journaux d'audit",
					Description = "Exporter les journaux d'audit en CSV ou JSON"
				}
			);
	}
}
