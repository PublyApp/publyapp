...
namespace PublyApp.Api.Migrations
{
    ...
    [Migration("20260822074600_AddSocialAccounts")]
            ...
            modelBuilder.Entity("PublyApp.Api.Modules.SocialAccounts.Entities.SocialAccount", b =>
                {
                    ...
                    b.ToTable("social_accounts", t =>
                        {
                            t.HasCheckConstraint("CK_SocialAccount_Provider", "provider >= 0");

                            t.HasCheckConstraint("CK_SocialAccount_Status", "status IN (0, 1, 2)");
                        });
                });
