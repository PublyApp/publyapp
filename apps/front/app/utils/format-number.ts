...
export const fNumber = (inputValue: InputNumberValue, options?: Options) => {
...
export const fCurrency = (inputValue: InputNumberValue, options?: Options) => {
	const locale = formatNumberLocale() || DEFAULT_LOCALE;
...
export const fPercent = (inputValue: InputNumberValue, options?: Options) => {
	const locale = formatNumberLocale() || DEFAULT_LOCALE;
