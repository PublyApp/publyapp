...
export default function CodeExampleTabs({ tab1, tab2 }: { tab1?: any; tab2?: any }) {
	return (
		<Tabs.Root className="mt-14 grid grid-cols-12 gap-8" defaultValue="tab1" orientation="vertical">
			<Tabs.List className="col-span-full flex w-full flex-col gap-8 md:order-2 md:col-span-5" aria-label="Select code">
				<Tabs.Trigger
				...
				>
					<div className="absolute -left-[36px] top-1/2 hidden -rotate-90 group-data-[state=active]:flex">
						<Arrow width={18} height={8} className="fill-gray-950 dark:fill-gray-900" />
					</div>
					...
					<p className="mt-4 leading-7 text-gray-600 dark:text-gray-400">
						Data integrity and query efficiency for diverse data types including geospatial and time-series. Easy to
						create, effortless to maintain.
					</p>
				</Tabs.Trigger>
				<Tabs.Trigger
					className="group relative flex flex-1 flex-col items-start justify-start rounded-xl p-6 text-left shadow-lg ring-1 ring-gray-200 dark:ring-white/5 dark:data-[state=active]:shadow-indigo-900/30"
				...
				>
					...
					<p className="mt-4 leading-7 text-gray-600 dark:text-gray-400">
						Leverage a developer-native query API to efficiently manage PostgreSQL data. Initialize once, scale
						infinitely.
					</p>
				</Tabs.Trigger>
			</Tabs.List>
