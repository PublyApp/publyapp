...
export const _productsCompare = ['Apple iPhone 12 Pro', 'Apple iPhone 13 Pro', 'Apple iPhone 14 Pro'].map(
	(name, index) => ({
		id: _mock.id(index),
		name,
		price: _mock.number.price(index),
...
export const _products = [...Array(24)].map((_, index) => ({
	...
	price: _mock.number.price(index),
	priceSale:
		[_mock.number.price(1), _mock.number.price(2), _mock.number.price(3), _mock.number.price(4), _mock.number.price(5)][
			index
		] || 0,
	images: [
