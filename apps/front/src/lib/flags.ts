...
/**
 * Static feature-flag registry (front) — old-front equivalent was `apps/old-front/src/lib/features/flags.ts` (see `docs/archive/old-front/screens/marketing.md` for the retired flag set).
 * lib/features/flags.ts at retirement). Read at module load, so `import.meta.env` inlines
