...
const deriveTenantProfileCardStyle = (
	name: string,
	icon?: string | null,
	tone?: string | null,
): TenantProfileCardStyle => {
	let sum = 0;
...
export { deriveTenantProfileCardStyle };
export type { TenantProfileCardStyle };
