...
type ToolbarFiltersProps = {
	...
	isLocked: boolean;
	onSetLevels: (next: KnownTenantUserLevel[]) => void;
	onToggleLevel: (level: KnownTenantUserLevel) => void;
	onSetStatuses: (next: KnownTenantUserStatus[]) => void;
	onToggleStatus: (status: KnownTenantUserStatus) => void;
};

/** Account-level / status dropdown pair rendered at the far end of the
