	...
	return (
		...
		>
			<Stack spacing={6}>
				...
				<Box component="section">
					<Typography component="h2" id={TERMS_SECTION_IDS.billing} sx={H2_SX}>
						4. Subscription and Billing
					</Typography>
					<Stack spacing={2}>
						<Typography sx={P_SX}>
				...
				{/* 9. Changes to Terms */}
				<Box component="section">
					<Typography component="h2" id={TERMS_SECTION_IDS.changes} sx={H2_SX}>
						9. Changes to Terms
					</Typography>
					<Stack spacing={2}>
						<Typography sx={P_SX}>
				...
				{/* 10. Contact */}
				<Box component="section">
					<Typography component="h2" id={TERMS_SECTION_IDS.contact} sx={H2_SX}>
						10. Contact
					</Typography>
					<Stack spacing={2}>
						<Typography sx={P_SX}>
