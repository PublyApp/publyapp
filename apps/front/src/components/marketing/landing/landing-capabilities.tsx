...
export const LandingCapabilities = () => {
	...
	return (
		<div className="publy-landing-section-body relative">
			...
			<div
				aria-hidden="true"
				className="publy-landing-fact-divider pointer-events-none absolute left-1/3 hidden w-px bg-(--publy-border) lg:block"
			/>
			<div
				aria-hidden="true"
				className="publy-landing-fact-divider pointer-events-none absolute left-2/3 hidden w-px bg-(--publy-border) lg:block"
			/>
			...
			<ul
				role="list"
				className="publy-landing-fact-grid grid list-none gap-x-8 md:grid-cols-2 lg:grid-cols-3"
			>
				{CAPABILITY_FACTS.map((fact) => (
					<li key={fact.key} className="publy-landing-fact-cell py-8">
						<fact.Icon
