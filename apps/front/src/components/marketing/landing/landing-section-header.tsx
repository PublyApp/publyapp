 ...
 * (`landing.css`, "THE SPACING SCALE"): 20px eyebrow→heading so the gap
...
export const LandingSectionHeader = ({
	...
	return (
		<div>
			...
			<h2
				id={headingId}
				className="publy-type-sky-display-2 publy-landing-header-heading publy-landing-optical-flush max-w-[24ch] text-balance text-(--publy-foreground)"
			>
				{t(titleKey)}
			</h2>
