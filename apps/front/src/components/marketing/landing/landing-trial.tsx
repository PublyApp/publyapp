 ...
 * now this section's DEK, rendered by `LandingSectionHeader` at the lead
...
export const LandingTrial = () => {
	...
	return (
		<ol
			...
			className="publy-marketing-hairline-grid publy-landing-section-body grid list-none grid-cols-1 md:grid-cols-3"
		>
