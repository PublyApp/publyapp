...
export const Landing05Capabilities = () => {
	const { t } = useTranslation('landing-05');

	return (
		<div className="publy-l05-fact-grid relative mt-8 grid gap-x-4 md:grid-cols-2 lg:grid-cols-3">
			<div
				aria-hidden="true"
			...
			{CAPABILITY_FACTS.map((fact) => (
				<div key={fact.key} className="publy-l05-fact-cell p-8 pr-4">
					<fact.Icon
