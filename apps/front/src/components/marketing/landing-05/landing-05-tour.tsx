...
import { TOUR_TABS, type TourTabId } from './landing-05-tour-tabs';
		...
		<div>
			...
			<div className="mt-8 hidden md:block">
				...
				>
					<span
						aria-hidden="true"
						className="publy-l05-tour-rail-indicator absolute inset-y-0 left-0 w-1/5 bg-(--publy-primary)"
					/>
				</div>
			</div>
					...
					return (
						<div key={tab.id}>
							...
							<div
								...
								className={cn(
									'publy-l05-accordion-panel',
									isOpen && 'publy-l05-accordion-panel-open',
								)}
							>
								<div className="publy-l05-accordion-panel-inner px-4 pb-4">
			...
			<div className="relative mt-6 md:mt-0">
				<div
					aria-hidden="true"
					className="publy-l05-radius-band pointer-events-none absolute inset-0 -inset-x-1.5 -bottom-1.5 border-x border-b border-(--publy-border) md:-inset-x-2.5 md:-bottom-2.5"
				/>
				<div
					className={cn(
						'publy-l05-ring publy-l05-shadow-window publy-sky-focus-in relative isolate overflow-hidden rounded-[var(--publy-radius-medium-control)] bg-(--publy-surface)',
						ringPulsing && 'publy-l05-ring-strong',
					)}
				>
					<div className="flex h-10 items-center justify-between gap-3 border-b border-(--publy-border) bg-(--publy-surface) px-3">
						<span className="publy-l05-eyebrow-chip text-xs font-medium normal-case tracking-normal">
