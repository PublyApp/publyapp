 ...
 * draw for free). Every number lives in `styles/landing-05.css`.
 *
 * Variants:
 ...
 * - `hero`: follows the header, not a section (64/80/96 top), and closes at
 ...
 */
const VARIANT_CLASS = {
	standard: 'publy-l05-section',
	hero: 'publy-l05-section-hero',
	window: 'publy-l05-section-window',
} as const;

type Landing05SectionProps = {
