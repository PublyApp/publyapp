 ...
 * page (`landing-05.css` §"the ruled column"). Its content shares the ruled
 ...
 */
export const Landing05Footer = () => {
	const { t } = useTranslation('landing-05');
	const year = new Date().getFullYear();

	return (
		<footer
			data-testid="landing-05-footer"
			className="mt-auto border-t border-(--publy-border)"
		>
			<div className="publy-l05-ruled-column flex flex-col gap-8 px-4 py-10 sm:px-6 sm:py-12">
					...
					>
						...
						<Link
							...
							className={cn(
								...
								'publy-l05-pressable no-underline',
							)}
						>
							{t('landing-nav-cta')}
						</Link>
