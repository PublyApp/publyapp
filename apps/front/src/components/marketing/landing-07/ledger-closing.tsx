...
export const LedgerClosing = () => {
	...
	return (
		<div>
			<TickRuler />
			<div className="ld07-closing-panel bg-(--publy-primary) px-6 py-12 md:px-10 md:py-16 xl:px-14 xl:py-20">
				<div className="flex flex-col gap-5">
					<span className="publy-type-eyebrow text-(--publy-primary-foreground-subtle)">
						{t('closing-eyebrow')}
					</span>
					...
					<div className="mt-3 flex flex-wrap items-center gap-3">
						<Link
							to="/signup"
							className="inline-flex h-11 items-center rounded-[var(--publy-radius-control)] bg-(--publy-primary-foreground) px-5 text-[15px]/[20px] font-semibold tracking-(--publy-tracking-text) text-(--publy-primary) no-underline transition-transform duration-200 ease-[cubic-bezier(0.22,1,0.36,1)] active:translate-y-px active:duration-50"
						>
							{t('closing-primary-cta')}
						</Link>
						<a
							href="#row-04"
							className="inline-flex h-11 items-center rounded-[var(--publy-radius-control)] border border-(--publy-primary-foreground-subtle) bg-transparent px-5 text-[15px]/[20px] font-semibold tracking-(--publy-tracking-text) text-(--publy-primary-foreground) no-underline transition-transform duration-200 ease-[cubic-bezier(0.22,1,0.36,1)] active:translate-y-px active:duration-50"
						>
