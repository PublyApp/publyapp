 ...
 *
 * - `Landing05ADawn` — full-bleed, warming downward, brightest in the last
 *   200px before the horizon, the way a real dawn concentrates at the ground.
 *   It holds the hero and nothing else.
 * - `Landing05ADay` — no field at all. Paper, ruled. This is where the whole
 ...
 * - `Landing05ANight` — full-bleed, deepening downward. It opens at the second
 ...
 */
export const Landing05ADawn = ({ children }: { children: ReactNode }) => (
	<div className="publy-l05a-dawn">{children}</div>
);

export const Landing05ADay = ({ children }: { children: ReactNode }) => (
	<div className="publy-l05a-day">{children}</div>
);

export const Landing05ANight = ({
	foot = false,
	children,
}: {
	...
	<div className={foot ? 'publy-l05a-night-foot' : 'publy-l05a-night'}>
		{children}
	</div>
);
