...
import { Landing05ANight } from './landing-05-a-regions';
 ...
 * this, and no change of field: `Landing05ANight foot` picks the closing
...
export const Landing05AFooter = () => {
	...
	return (
		<footer data-testid="landing-05-a-footer" className="mt-auto">
			<Landing05ANight foot>
				<div className="publy-l05a-ruled-column px-4 pt-4 pb-16 sm:px-6 sm:pt-8 sm:pb-24">
