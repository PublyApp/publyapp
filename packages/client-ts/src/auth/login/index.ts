...
import {
	...
	createPasswordLoginResultFromDiscriminatorValue,
	createValidationProblemDetailsFromDiscriminatorValue,
	serializePasswordLoginBody,
	serializePasswordLoginResult,
...
export interface LoginRequestBuilder
	extends BaseRequestBuilder<LoginRequestBuilder> {
	/**
	 * Password Login
	...
	): Promise<PasswordLoginResult | undefined>;
	/**
	 * Password Login
	 * @param body The request body
	 * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
