...
import {
	...
	createPasswordRegisterResultFromDiscriminatorValue,
	createValidationProblemDetailsFromDiscriminatorValue,
	serializePasswordRegisterBody,
	serializePasswordRegisterResult,
	type AppProblemDetails,
	type PasswordRegisterBody,
	type PasswordRegisterResult,
...
export interface RegisterRequestBuilder
	extends BaseRequestBuilder<RegisterRequestBuilder> {
	/**
	 * Password Register
	 ...
	 */
	post(
		body: PasswordRegisterBody,
		requestConfiguration?: RequestConfiguration<object> | undefined,
	): Promise<PasswordRegisterResult | undefined>;
	/**
	 * Password Register
	 * @param body The request body
	 * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
