 ...
 */
export interface ProductsItemRequestBuilder
	extends BaseRequestBuilder<ProductsItemRequestBuilder> {
	/**
	 * Delete a product
 ...
 */
export const ProductsItemRequestBuilderUriTemplate =
	'{+baseurl}/tenant/products/{id}';
/**
