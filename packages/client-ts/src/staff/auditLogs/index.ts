...
import {
	...
	createFindAuditLogsResponseFromDiscriminatorValue,
	createValidationProblemDetailsFromDiscriminatorValue,
	type AppProblemDetails,
	type FindAuditLogsResponse,
	type ValidationProblemDetails,
} from '../../models/index.js';
// @ts-ignore
import {
	ActionsRequestBuilderRequestsMetadata,
	type ActionsRequestBuilder,
} from './actions/index.js';
// @ts-ignore
import {
	ExportRequestBuilderRequestsMetadata,
	type ExportRequestBuilder,
} from './exportEscaped/index.js';
// @ts-ignore
import {
	type WithLogItemRequestBuilder,
	WithLogItemRequestBuilderRequestsMetadata,
} from './item/index.js';
// @ts-ignore
import {
 ...
 */
export interface AuditLogsRequestBuilder
	extends BaseRequestBuilder<AuditLogsRequestBuilder> {
	/**
	...
	get(
		requestConfiguration?:
			| RequestConfiguration<AuditLogsRequestBuilderGetQueryParameters>
			| undefined,
	): Promise<FindAuditLogsResponse | undefined>;
	/**
	 * List audit logs with pagination and filters
	 * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
...
export const AuditLogsRequestBuilderUriTemplate =
	'{+baseurl}/staff/audit-logs{?Action*,Cursor*,EndDate*,Limit*,SortId*,SortOrder*,StartDate*,TargetId*,UserId*}';
/**
 ...
 */
export const AuditLogsRequestBuilderNavigationMetadata: Record<
	Exclude<keyof AuditLogsRequestBuilder, KeysToExcludeForNavigationMetadata>,
	NavigationMetadata
> = {
	byLogId: {
