...
import {
	...
	createAuditLogDetailFromDiscriminatorValue,
 ...
 */
export interface WithLogItemRequestBuilder
	extends BaseRequestBuilder<WithLogItemRequestBuilder> {
	/**
	...
	): Promise<AuditLogDetail | undefined>;
	/**
	 * Get an audit log entry by ID
	 * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const WithLogItemRequestBuilderUriTemplate =
	'{+baseurl}/staff/audit-logs/{logId}';
/**
