...
// @ts-ignore
import { createAppProblemDetailsFromDiscriminatorValue, createGetAuditLogActionsResponseFromDiscriminatorValue, type AppProblemDetails, type GetAuditLogActionsResponse } from '../../../models/index.js';
// @ts-ignore
...
export interface ActionsRequestBuilder extends BaseRequestBuilder<ActionsRequestBuilder> {
     ...
     */
     get(requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<GetAuditLogActionsResponse | undefined>;
    /**
     * Get all available audit log action keys
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const ActionsRequestBuilderUriTemplate = "{+baseurl}/staff/audit-logs/actions";
/**
