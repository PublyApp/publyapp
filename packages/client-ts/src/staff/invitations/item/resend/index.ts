...
/**
 * Builds and executes requests for operations under /staff/invitations/{invitationId}/resend
 */
export interface ResendRequestBuilder
	extends BaseRequestBuilder<ResendRequestBuilder> {
	/**
 ...
 */
export const ResendRequestBuilderUriTemplate =
	'{+baseurl}/staff/invitations/{invitationId}/resend';
/**
