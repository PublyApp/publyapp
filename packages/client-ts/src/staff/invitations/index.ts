...
import {
	...
	createFindStaffInvitationsResultFromDiscriminatorValue,
	createInvitationCreatedFromDiscriminatorValue,
	createValidationProblemDetailsFromDiscriminatorValue,
	serializeCreateStaffInvitationBody,
	serializeInvitationCreated,
	type AppProblemDetails,
	type CreateStaffInvitationBody,
	type FindStaffInvitationsResult,
	type InvitationCreated,
	type ValidationProblemDetails,
} from '../../models/index.js';
// @ts-ignore
import {
	BulkRequestBuilderRequestsMetadata,
	type BulkRequestBuilder,
} from './bulk/index.js';
// @ts-ignore
import {
	type WithInvitationItemRequestBuilder,
	WithInvitationItemRequestBuilderNavigationMetadata,
	WithInvitationItemRequestBuilderRequestsMetadata,
} from './item/index.js';
// @ts-ignore
import {
 ...
 */
export interface InvitationsRequestBuilder
	extends BaseRequestBuilder<InvitationsRequestBuilder> {
	/**
	 * The bulk property
	 */
	...
	get(
		requestConfiguration?:
			| RequestConfiguration<InvitationsRequestBuilderGetQueryParameters>
			| undefined,
	): Promise<FindStaffInvitationsResult | undefined>;
	/**
	...
	): Promise<InvitationCreated | undefined>;
	/**
	 * Find staff invitations
	 * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
...
export const InvitationsRequestBuilderUriTemplate =
	'{+baseurl}/staff/invitations{?Cursor*,Limit*,SortId*,SortOrder*,Status*}';
/**
 * Mapper for query parameters from symbol name to serialization name represented as a constant.
 */
const InvitationsRequestBuilderGetQueryParametersMapper: Record<
	string,
	string
> = {
	cursor: 'Cursor',
 ...
 */
export const InvitationsRequestBuilderNavigationMetadata: Record<
	Exclude<keyof InvitationsRequestBuilder, KeysToExcludeForNavigationMetadata>,
	NavigationMetadata
> = {
	byInvitationId: {
