...
/**
 * Builds and executes requests for operations under /staff/tenant-users
 */
 ...
 */
export const TenantUsersRequestBuilderUriTemplate = "{+baseurl}/staff/tenant-users";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const TenantUsersRequestBuilderNavigationMetadata: Record<Exclude<keyof TenantUsersRequestBuilder, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    byUserId: {
