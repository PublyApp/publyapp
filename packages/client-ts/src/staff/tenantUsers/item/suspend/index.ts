...
/**
 * Builds and executes requests for operations under /staff/tenant-users/{userId}/suspend
 */
export interface SuspendRequestBuilder extends BaseRequestBuilder<SuspendRequestBuilder> {
    /**
     * Globally suspend a tenant user identity
 ...
 */
export const SuspendRequestBuilderUriTemplate = "{+baseurl}/staff/tenant-users/{userId}/suspend";
/**
