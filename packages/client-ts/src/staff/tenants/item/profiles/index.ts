...
import {
	...
	createFindTenantProfilesAsStaffResultFromDiscriminatorValue,
	createValidationProblemDetailsFromDiscriminatorValue,
	type AppProblemDetails,
	type FindTenantProfilesAsStaffResult,
...
export interface ProfilesRequestBuilder
	...
	get(
		requestConfiguration?:
			...
			| undefined,
	): Promise<FindTenantProfilesAsStaffResult | undefined>;
	/**
	 * Find profiles for a tenant
	 * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
...
export const ProfilesRequestBuilderUriTemplate =
	'{+baseurl}/staff/tenants/{tenantId}/profiles{?Limit*,Page*,SortId*,SortOrder*}';
/**
