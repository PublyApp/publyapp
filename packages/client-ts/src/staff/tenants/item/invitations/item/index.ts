...
/**
 * Builds and executes requests for operations under /staff/tenants/{tenantId}/invitations/{invitationId}
 */
 ...
 */
export const WithInvitationItemRequestBuilderUriTemplate = "{+baseurl}/staff/tenants/{tenantId}/invitations/{invitationId}";
/**
