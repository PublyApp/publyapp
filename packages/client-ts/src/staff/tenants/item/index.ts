...
// @ts-ignore
import {
	ProfilesRequestBuilderRequestsMetadata,
	type ProfilesRequestBuilder,
...
import {
	...
	UsersRequestBuilderRequestsMetadata,
} from './users/index.js';
// @ts-ignore
import {
 ...
 */
export interface WithTenantItemRequestBuilder
	extends BaseRequestBuilder<WithTenantItemRequestBuilder> {
	/**
	...
	get(
		requestConfiguration?: RequestConfiguration<object> | undefined,
	): Promise<GetTenantAsStaffResult | undefined>;
	/**
	 * Update a tenant
 ...
 */
export const WithTenantItemRequestBuilderNavigationMetadata: Record<
	Exclude<
		keyof WithTenantItemRequestBuilder,
