...
import {
	...
	createTenantSuspendedResultFromDiscriminatorValue,
	createValidationProblemDetailsFromDiscriminatorValue,
	serializeSuspendTenantAsStaffBody,
	serializeTenantSuspendedResult,
	type AppProblemDetails,
	type SuspendTenantAsStaffBody,
	type TenantSuspendedResult,
 ...
 */
export interface SuspendRequestBuilder
	extends BaseRequestBuilder<SuspendRequestBuilder> {
	/**
	 * Suspend a tenant
	 ...
	 */
	post(
		body: SuspendTenantAsStaffBody,
		requestConfiguration?: RequestConfiguration<object> | undefined,
	): Promise<TenantSuspendedResult | undefined>;
	/**
	 * Suspend a tenant
	 * @param body The request body
	 * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const SuspendRequestBuilderUriTemplate =
	'{+baseurl}/staff/tenants/{tenantId}/suspend';
/**
