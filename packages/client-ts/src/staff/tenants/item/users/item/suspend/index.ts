...
// @ts-ignore
import { createAppProblemDetailsFromDiscriminatorValue, createSuspendTenantUserResultFromDiscriminatorValue, type AppProblemDetails, type SuspendTenantUserResult } from '../../../../../../models/index.js';
// @ts-ignore
...
export interface SuspendRequestBuilder extends BaseRequestBuilder<SuspendRequestBuilder> {
     ...
     * @returns {Promise<SuspendTenantUserResult>}
     ...
     */
     post(requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<SuspendTenantUserResult | undefined>;
    /**
     * Suspend a tenant user
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
...
export const SuspendRequestBuilderRequestsMetadata: RequestsMetadata = {
    post: {
        ...
        responseBodyFactory:  createSuspendTenantUserResultFromDiscriminatorValue,
    },
};
/* tslint:enable */
/* eslint-enable */
