...
// @ts-ignore
import { createAppProblemDetailsFromDiscriminatorValue, createReactivateTenantUserResultFromDiscriminatorValue, type AppProblemDetails, type ReactivateTenantUserResult } from '../../../../../../models/index.js';
// @ts-ignore
...
export interface ReactivateRequestBuilder extends BaseRequestBuilder<ReactivateRequestBuilder> {
     ...
     * @returns {Promise<ReactivateTenantUserResult>}
     ...
     */
     post(requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<ReactivateTenantUserResult | undefined>;
    /**
     * Reactivate a suspended tenant user
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
...
export const ReactivateRequestBuilderRequestsMetadata: RequestsMetadata = {
    post: {
        ...
        responseBodyFactory:  createReactivateTenantUserResultFromDiscriminatorValue,
    },
};
/* tslint:enable */
/* eslint-enable */
