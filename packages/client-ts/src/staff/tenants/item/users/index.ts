...
import {
	...
	createFindTenantUsersAsStaffResultFromDiscriminatorValue,
	createValidationProblemDetailsFromDiscriminatorValue,
	type AppProblemDetails,
	type FindTenantUsersAsStaffResult,
...
export interface UsersRequestBuilder
	...
	get(
		requestConfiguration?:
			...
			| undefined,
	): Promise<FindTenantUsersAsStaffResult | undefined>;
	/**
	 * Find users for a tenant
	 * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
...
export const UsersRequestBuilderUriTemplate =
	'{+baseurl}/staff/tenants/{tenantId}/users{?Cursor*,Limit*,SortId*,SortOrder*}';
/**
