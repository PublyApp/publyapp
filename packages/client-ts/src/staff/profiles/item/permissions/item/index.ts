...
/**
 * Builds and executes requests for operations under /staff/profiles/{profileId}/permissions/{permissionKey}
 */
export interface WithPermissionKeyItemRequestBuilder extends BaseRequestBuilder<WithPermissionKeyItemRequestBuilder> {
    /**
     * Unassign a permission key from a staff profile
    ...
    /**
     * Assign a permission key to a staff profile
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @throws {AppProblemDetails} error when the service returns a 400 status code
     * @throws {AppProblemDetails} error when the service returns a 401 status code
     * @throws {AppProblemDetails} error when the service returns a 403 status code
 ...
 */
export const WithPermissionKeyItemRequestBuilderUriTemplate = "{+baseurl}/staff/profiles/{profileId}/permissions/{permissionKey}";
/**
