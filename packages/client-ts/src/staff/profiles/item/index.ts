...
// @ts-ignore
import { createAppProblemDetailsFromDiscriminatorValue, createGetStaffProfileByIdResultFromDiscriminatorValue, type AppProblemDetails, type GetStaffProfileByIdResult } from '../../../models/index.js';
// @ts-ignore
