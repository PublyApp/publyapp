...
// @ts-ignore
import { createApiResponseFromDiscriminatorValue, createAppProblemDetailsFromDiscriminatorValue, createValidationProblemDetailsFromDiscriminatorValue, serializeApiResponse, serializeUnassignStaffProfileUsersBody, type ApiResponse, type AppProblemDetails, type UnassignStaffProfileUsersBody, type ValidationProblemDetails } from '../../../../../models/index.js';
// @ts-ignore
...
export interface UnassignRequestBuilder extends BaseRequestBuilder<UnassignRequestBuilder> {
     ...
     */
     post(body: UnassignStaffProfileUsersBody, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<ApiResponse | undefined>;
    /**
     * Bulk-unassign staff users from a staff profile
     * @param body The request body
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
