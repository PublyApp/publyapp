 ...
 */
export interface ProfilesRequestBuilder
	extends BaseRequestBuilder<ProfilesRequestBuilder> {
	/**
	...
	get(
		requestConfiguration?:
			| RequestConfiguration<ProfilesRequestBuilderGetQueryParameters>
			| undefined,
	): Promise<FindStaffProfilesResult | undefined>;
	/**
	 ...
	 */
	post(
		body: CreateStaffProfileBody,
		requestConfiguration?: RequestConfiguration<object> | undefined,
	): Promise<StaffProfileCreated | undefined>;
	/**
	 * Find profiles for a staff member
	 * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
...
export const ProfilesRequestBuilderUriTemplate =
	'{+baseurl}/staff/profiles{?Cursor*,Limit*,SortId*,SortOrder*}';
/**
