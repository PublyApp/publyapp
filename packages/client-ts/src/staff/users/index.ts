...
export interface UsersRequestBuilder
	extends BaseRequestBuilder<UsersRequestBuilder> {
	/**
	...
	get(
		requestConfiguration?:
			| RequestConfiguration<UsersRequestBuilderGetQueryParameters>
			| undefined,
...
export const UsersRequestBuilderUriTemplate =
	'{+baseurl}/staff/users{?Limit*,Page*,SortId*,SortOrder*}';
/**
 ...
 */
export const UsersRequestBuilderNavigationMetadata: Record<
	Exclude<keyof UsersRequestBuilder, KeysToExcludeForNavigationMetadata>,
	NavigationMetadata
> = {
	byUserId: {
