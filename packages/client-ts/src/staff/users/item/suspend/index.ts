...
// @ts-ignore
import { createAppProblemDetailsFromDiscriminatorValue, createStaffUserSuspendedResultFromDiscriminatorValue, type AppProblemDetails, type StaffUserSuspendedResult } from '../../../../models/index.js';
// @ts-ignore
import { type BaseRequestBuilder, type Parsable, type ParsableFactory, type RequestConfiguration, type RequestInformation, type RequestsMetadata } from '@microsoft/kiota-abstractions';

/**
 * Builds and executes requests for operations under /staff/users/{userId}/suspend
 */
export interface SuspendRequestBuilder extends BaseRequestBuilder<SuspendRequestBuilder> {
     ...
     * @returns {Promise<StaffUserSuspendedResult>}
     ...
     */
     post(requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<StaffUserSuspendedResult | undefined>;
    /**
     * Suspend a staff user
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const SuspendRequestBuilderUriTemplate = "{+baseurl}/staff/users/{userId}/suspend";
/**
...
export const SuspendRequestBuilderRequestsMetadata: RequestsMetadata = {
    post: {
        ...
        responseBodyFactory:  createStaffUserSuspendedResultFromDiscriminatorValue,
    },
};
/* tslint:enable */
/* eslint-enable */
