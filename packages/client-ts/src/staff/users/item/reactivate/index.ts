...
// @ts-ignore
import { createAppProblemDetailsFromDiscriminatorValue, createStaffUserReactivatedResultFromDiscriminatorValue, type AppProblemDetails, type StaffUserReactivatedResult } from '../../../../models/index.js';
// @ts-ignore
import { type BaseRequestBuilder, type Parsable, type ParsableFactory, type RequestConfiguration, type RequestInformation, type RequestsMetadata } from '@microsoft/kiota-abstractions';

/**
 * Builds and executes requests for operations under /staff/users/{userId}/reactivate
 */
export interface ReactivateRequestBuilder extends BaseRequestBuilder<ReactivateRequestBuilder> {
     ...
     * @returns {Promise<StaffUserReactivatedResult>}
     ...
     */
     post(requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<StaffUserReactivatedResult | undefined>;
    /**
     * Reactivate a staff user
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const ReactivateRequestBuilderUriTemplate = "{+baseurl}/staff/users/{userId}/reactivate";
/**
...
export const ReactivateRequestBuilderRequestsMetadata: RequestsMetadata = {
    post: {
        ...
        responseBodyFactory:  createStaffUserReactivatedResultFromDiscriminatorValue,
    },
};
/* tslint:enable */
/* eslint-enable */
