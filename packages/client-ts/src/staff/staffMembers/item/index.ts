...
import {
	...
	createGetStaffUserByIdResultFromDiscriminatorValue,
	createValidationProblemDetailsFromDiscriminatorValue,
	serializeApiResponse,
	serializeUpdateStaffUserBody,
	type ApiResponse,
	type AppProblemDetails,
	type GetStaffUserByIdResult,
 ...
 */
export interface WithUserItemRequestBuilder
	extends BaseRequestBuilder<WithUserItemRequestBuilder> {
	/**
...
export const WithUserItemRequestBuilderUriTemplate =
	'{+baseurl}/staff/staff-users/{userId}';
/**
