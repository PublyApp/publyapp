...
// @ts-ignore
import { createAppProblemDetailsFromDiscriminatorValue, createSystemJobDefinitionUpdatedResponseFromDiscriminatorValue, createValidationProblemDetailsFromDiscriminatorValue, serializeSystemJobDefinitionUpdatedResponse, serializeUpdateSystemJobDefinitionEnabledForStaffBody, type AppProblemDetails, type SystemJobDefinitionUpdatedResponse, type UpdateSystemJobDefinitionEnabledForStaffBody, type ValidationProblemDetails } from '../../../../../models/index.js';
// @ts-ignore
import { type BaseRequestBuilder, type Parsable, type ParsableFactory, type RequestConfiguration, type RequestInformation, type RequestsMetadata } from '@microsoft/kiota-abstractions';

/**
 * Builds and executes requests for operations under /staff/jobs/system-jobs/{systemJobId}/enabled
 */
export interface EnabledRequestBuilder extends BaseRequestBuilder<EnabledRequestBuilder> {
     ...
     */
     patch(body: UpdateSystemJobDefinitionEnabledForStaffBody, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<SystemJobDefinitionUpdatedResponse | undefined>;
    /**
     * @param body The request body
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @returns {RequestInformation}
     */
     toPatchRequestInformation(body: UpdateSystemJobDefinitionEnabledForStaffBody, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation;
}
/**
 * Uri template for the request builder.
 */
export const EnabledRequestBuilderUriTemplate = "{+baseurl}/staff/jobs/system-jobs/{systemJobId}/enabled";
/**
...
export const EnabledRequestBuilderRequestsMetadata: RequestsMetadata = {
    patch: {
        ...
        requestBodySerializer: serializeUpdateSystemJobDefinitionEnabledForStaffBody,
