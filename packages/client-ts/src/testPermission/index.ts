...
/**
 * Builds and executes requests for operations under /test-permission
 */
export interface TestPermissionRequestBuilder extends BaseRequestBuilder<TestPermissionRequestBuilder> {
    /**
 ...
 */
export const TestPermissionRequestBuilderUriTemplate = "{+baseurl}/test-permission";
/**
 * Metadata for all the requests in the request builder.
 */
export const TestPermissionRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: TestPermissionRequestBuilderUriTemplate,
