...
// @ts-ignore
import { createAccountProfileResultFromDiscriminatorValue, createAppProblemDetailsFromDiscriminatorValue, createValidationProblemDetailsFromDiscriminatorValue, serializeAccountProfileResult, serializeUpdateAccountProfileBody, type AccountProfileResult, type AppProblemDetails, type UpdateAccountProfileBody, type ValidationProblemDetails } from '../../models/index.js';
// @ts-ignore
...
export interface ProfileRequestBuilder extends BaseRequestBuilder<ProfileRequestBuilder> {
    /**
     * Get the signed-in user's tenant-scoped profile
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @returns {Promise<AccountProfileResult>}
     ...
     */
     get(requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<AccountProfileResult | undefined>;
    /**
     * Update the signed-in user's tenant-scoped profile
     ...
     * @throws {AppProblemDetails} error when the service returns a 500 status code
     */
     patch(body: UpdateAccountProfileBody, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<AccountProfileResult | undefined>;
    /**
     * Get the signed-in user's tenant-scoped profile
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     ...
     * @returns {RequestInformation}
     */
     toPatchRequestInformation(body: UpdateAccountProfileBody, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation;
}
/**
 * Uri template for the request builder.
 */
export const ProfileRequestBuilderUriTemplate = "{+baseurl}/account/profile";
/**
...
export const ProfileRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        ...
        responseBodyFactory:  createAccountProfileResultFromDiscriminatorValue,
    },
    patch: {
        uriTemplate: ProfileRequestBuilderUriTemplate,
        responseBodyContentType: "application/json",
        ...
        requestBodySerializer: serializeUpdateAccountProfileBody,
