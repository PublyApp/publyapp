...
ci: ci-drift ci-migration-expand-contract ci-review-worktree-resolution ci-doc-links ci-project-closure-adapter ci-no-ignored-tracked ci-install ci-format ci-lint ci-lint-ts ci-knip ci-shared-ts ci-quality ci-front ci-spec-drift nuget-audit test-api
  @echo ""
  @echo "=== just ci: PASSED ==="
