...
# Run analyzer tests
test-analyzers:
  dotnet restore packages/analyzers-cs/PublyApp.Analyzers.Tests/PublyApp.Analyzers.Tests.csproj
  dotnet test packages/analyzers-cs/PublyApp.Analyzers.Tests/PublyApp.Analyzers.Tests.csproj -c Release --no-restore --nologo
