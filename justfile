...
ci-jscpd:
  ...
  pnpm exec jscpd . --min-tokens 50 --ignore '/node_modules/**' --ignore '/bin/**' --ignore '/obj/**' --ignore '/dist/**' --ignore '/.artifacts/**' --ignore '**/Migrations/**' --ignore '.worktrees/**' --reporters json --output .dump/jscpd-report.json
