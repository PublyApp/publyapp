...
| Column | Meaning |
| --- | --- |
| `scope_kind` | `0` = Global, `1` = CreatorUser |
...
Physical deletion NEVER happens inline. The sweeper (jobs module) is the only
...
by anyone can never hide an in-flight re-reference.
