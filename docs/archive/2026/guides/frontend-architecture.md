...
Original location: docs/guides/frontend-architecture.md
Archive reason: Retired apps/front guide retained because archived designs depend on its point-in-time architecture.
Superseded by: docs/guides/front-2/index.md and docs/guides/front-2/conventions.md.
