...
Original location: docs/guides/tailwind-to-sx-mapping.md
Archive reason: Retired apps/front translation guide retained because archived marketing designs depend on it.
Superseded by: docs/guides/front-2/conventions.md, which uses Tailwind v4 directly.
