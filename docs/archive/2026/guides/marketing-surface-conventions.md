...
Original location: docs/guides/marketing-surface-conventions.md
Archive reason: Retired apps/front guide retained because archived marketing designs and another archived guide depend on its decisions.
Superseded by: docs/guides/front-2/conventions.md; front-2 has no marketing implementation yet.
