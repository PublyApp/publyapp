...
Original location: docs/guides/frontend-route-file-organization.md
Archive reason: Retired apps/front guide retained because another archived guide depends on its route-ownership decisions.
Superseded by: docs/guides/front-2/conventions.md and apps/front-2/src/routes.ts.
