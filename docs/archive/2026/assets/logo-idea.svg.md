...
Original location: docs/misc/logo-idea.svg
Archive reason: Retired logo draft retained because an archived README design depends on the original asset.
Superseded by: docs/assets/publyapp-mark.svg.
