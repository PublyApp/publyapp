...
Original location: docs/superpowers/specs/2026-05-02-cursor-sort-field-handler-design.md
Archive reason: Completed design retained only for architectural decision history.
Superseded by: docs/guides/cursor-keyset-pagination-guide.md and current API handlers.
