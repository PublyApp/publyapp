...
Original location: docs/superpowers/specs/2026-06-20-openapi-deterministic-output-design.md
Archive reason: Completed design retained only for architectural decision history.
Superseded by: Current OpenAPI generation code and docs/guides/openapi-kiota-safeguards.md.
