...
Original location: docs/superpowers/specs/2026-04-26-issue-190-full-service-attribute-cutover-design.md
Archive reason: Completed design retained only for architectural decision history.
Superseded by: docs/guides/csharp-coding-standards.md and current service registration code.
