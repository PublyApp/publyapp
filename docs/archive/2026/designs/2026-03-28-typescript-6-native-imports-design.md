...
Original location: docs/superpowers/specs/2026-03-28-typescript-6-native-imports-design.md
Archive reason: Completed design retained only for architectural decision history.
Superseded by: Current TypeScript workspace configuration and package manifests.
