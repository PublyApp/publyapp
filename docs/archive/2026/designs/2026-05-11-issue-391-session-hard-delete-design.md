...
Original location: docs/superpowers/specs/2026-05-11-issue-391-session-hard-delete-design.md
Archive reason: Completed design retained only for architectural decision history.
Superseded by: Current Auth module implementation and docs/guides/architecture-details.md.
