...
Original location: docs/changes/secure-httponly-cookie-clearing.md
Archive reason: Security record retained for incident and remediation history.
Superseded by: apps/front is retired; current session handling is defined by apps/front-2 and AGENTS.md.
