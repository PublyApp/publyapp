...
## User Prompt
Create homepage concept variant 4 for **PublyApp** (AI-first social publishing SaaS).

### Creative Direction
- Hero style: **glassmorphism-minimal**
- Layout angle: **social-proof-led**
- Motion style: **scroll-narrative**
- Color mood: **black-white-plus-single-accent**
