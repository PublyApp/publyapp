...
## User Prompt
Create homepage concept variant 1 for **PublyApp** (AI-first social publishing SaaS).

### Creative Direction
- Hero style: **glassmorphism-minimal**
- Layout angle: **jobs-to-be-done**
- Motion style: **parallax-subtle**
- Color mood: **frosted-blue-professional**
