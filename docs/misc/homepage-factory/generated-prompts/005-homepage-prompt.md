...
## User Prompt
Create homepage concept variant 5 for **PublyApp** (AI-first social publishing SaaS).

### Creative Direction
- Hero style: **glassmorphism-minimal**
- Layout angle: **feature-depth-comparison**
- Motion style: **micro-interactions-only**
- Color mood: **warm-neutral-with-electric-accent**
